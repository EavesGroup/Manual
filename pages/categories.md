...
<summary><h3 id="exHeader" style="float:left; color:white; margin: -40px 0px 0px 0px">{{ category }}<h3 id="dropdown-{{ category }}" onClick="changeDropdown(this.id)" style="color:gray; float:right; margin: -2px 0px 0px 10px">〉</h3></h3></summary>
<div class="row">
