...
Add [this file]({{ site.urlfile }}eaves-swatches.ai) to your Adobe Illustrator Swatches folder to easily access these palettes in Adobe.
...
### A Basic Hot/Cold Palette
  ...
  <img src="{{ site.urlimg }}swatches-01.png"
       alt="example of adding a legend"
       width="100%">
