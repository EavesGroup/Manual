...
### Layout
As the name suggests, this tag sets the layout of the page, which controls a lot of how the page looks. The majority of pages have the layout "page-fullwidth". The main landing pages (i.e. for Julia or VASP) have the "page" layout. I have also added [a copy of this page]({{ site.url }}{{ site.baseurl }}/appendix/ex_page-fullwidth) with the "page" layout for a more direct comparison. 
