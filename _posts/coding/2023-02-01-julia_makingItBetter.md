...
{% include figure image_path="/assets/images/Julia/flamegraph_example.png" caption="Example of a flamegraph from the [FlameGraphs.jl](https://timholy.github.io/FlameGraphs.jl/stable/#) documentation page." alt="Example of a flamegraph" width="90%" %}
...
{% include figure image_path="/assets/images/Julia/flamegraph_Sina-example.png" caption="Example of a flamegraph from Sina's code." alt="Example of a flamegraph" width="90%" %}
